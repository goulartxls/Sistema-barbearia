    ...
    useEffect(() => {
        const fetchCortes = async () => {
            ...
            if (user) {
                ...
                const agendamentosPassados = agendamentosData.filter(agendamento => new Date(agendamento.agendamento) < today);

                const agendamentosWithDetails = await Promise.all(agendamentosPassados.map(async agendamento => {
